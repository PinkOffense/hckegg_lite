...
abstract class VetRepository {
  Future<Result<List<VetRecord>>> getVetRecords(String userId, {String? farmId});
  ...
  Future<Result<List<VetRecord>>> getUpcomingAppointments(String userId, {String? farmId});
