...
abstract class VetRepository {
  ...
  Future<Result<List<VetRecord>>> getVetRecordsInRange(String userId, String startDate, String endDate);
  Future<Result<List<VetRecord>>> getVetRecordsByType(String userId, VetRecordType recordType);
  ...
  Future<Result<VetStatistics>> getStatistics(String userId, String startDate, String endDate);
}
...
class VetStatistics {
  const VetStatistics({
    ...
    required this.byRecordType,
  });

  final int totalRecords;
  final double totalCost;
  final int totalHensAffected;
  final Map<String, VetTypeStats> byRecordType;

  Map<String, dynamic> toJson() => {
        'total_records': totalRecords,
        'total_cost': totalCost,
        'total_hens_affected': totalHensAffected,
        'by_record_type': byRecordType.map((k, v) => MapEntry(k, v.toJson())),
      };
}
