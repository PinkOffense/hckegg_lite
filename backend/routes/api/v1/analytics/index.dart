...
/// GET /api/v1/analytics - Get complete dashboard analytics
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    final result = await repository.getDashboardAnalytics(userId, farmId: farmId);

    return result.fold(
      onSuccess: (analytics) => Response.json(body: {'data': analytics.toJson()}),
